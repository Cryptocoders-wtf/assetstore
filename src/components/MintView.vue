<template>
  <div>
      ...
      <div v-else>
        ...
        <span v-else>
          ...
          <span v-else>
            ...
            <div v-if="lang === 'ja'">
              <p class="mb-2">
                フリーミントですが、ガス代が0.005〜0.015ETH程度かかります（混雑状況によって大きく変動）。
              </p>
              <p class="mb-2">
    ...
    <div v-if="tokens.length > 0">
      <div class="mt-4 mb-4">
        <p v-if="lang === 'ja'" class="font-bold">
          【既にミント済みのMaterial Icon】
        </p>
