...
const lang = {
  ...
  draw: {
    message1: "これは、自由に絵を描いて、それをフルオンチェーンNFTとしてミントできるサービスです。",
    message2: "全てを自分で描く限りは、フリーミントです（絵の複雑さに応じたガス代が必要です）。",
    message3: "他の人の作品をベースに絵を描いたり（リミックス）、",
    message4: "ブロックチェーン上のアセットを貼り付けることも可能です（オーバーレイ）。",
    message5: "リミックスやオーバーレイをした作品をミントする場合は有料で、そのお金はクリエーターたちに配布されます。",
    message6: "つまり、あなた自身がクリエーターとしてお金を稼ぐことも可能なのです（Draw2Earn）。",
    message7: "下のプラスアイコンをクリックして描き初めてください。",
    message8: "描き終わったら、右上のXボタンでキャンバスを閉じ、NFTをミントしてみて下さい。",
    message9: "",
  },
  languages,
};
